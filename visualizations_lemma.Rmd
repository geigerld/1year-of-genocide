...
```{r}
plot_outlet(c("..Israel","..Gaza","..Palestine","..Iran","..Rafa","..Lebanon","..Egypt","..Westbank","..West_bank","..United_states","..United_Nations","..UN"))

#without Israel and Gaza
plot_outlet(c("..Palestine","..Iran","..Rafa","..Lebanon","..Egypt","..Westbank","..West_bank","..United_states","..United_Nations","..UN"))
```
...
```{r}
plot_outlet(c("..War","..Ceasefire","..Support","..Pressure","..Negotiations","..Protest","..Suffering","..Release_hostage","..Escalation","..Terror_attack"))
```

Directly Involved Parties:
```{r}
plot_outlet(c("..Hamas","..Israeli_military","..Israeli_Government", "Palestinians.." ,"Israelis..","..Hezbollah","..idf"))
...
plot <- plot_outlet(c("..Attack","..Kill","..Terror","..Displace"))


ggsave("plots/Actions.pdf", scale = 0.6, plot,  width = 60,
